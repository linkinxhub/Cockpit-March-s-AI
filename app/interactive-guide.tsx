...
const steps: GuideStep[] = [
  ...
  { selector: "[data-guide='analysis-journey']", view: "Cockpit", title: { fr: "Votre fil d’analyse", en: "Your analysis path", de: "Ihr Analyseweg", nl: "Uw analysepad" }, text: { fr: "Comprenez la lecture, comparez les horizons et préparez votre suivi. Les accès au journal, aux alertes et aux passeports dépendent de votre pack.", en: "Understand the reading, compare horizons and prepare your follow-up. Journal, alerts and passports depend on your plan.", de: "Verstehen Sie die Einschätzung, vergleichen Sie Horizonte und bereiten Sie die weitere Beobachtung vor. Journal, Alarme und Pässe hängen von Ihrem Tarif ab.", nl: "Begrijp de lezing, vergelijk horizons en bereid uw opvolging voor. Journal, waarschuwingen en paspoorten hangen af van uw pakket." } },
