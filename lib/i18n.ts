...
const words: Record<string, [string, string, string]> = {
  "Découvrir Expert": ["Explore Expert", "Expert entdecken", "Ontdek Expert"],
  "Débloquer avec Expert": ["Unlock with Expert", "Mit Expert freischalten", "Ontgrendelen met Expert"],
  "L’analyse IA reste visible et peut être débloquée avec la formule Expert.": ["AI analysis can be unlocked with the Expert plan.", "Die KI-Analyse kann mit dem Expert-Tarif freigeschaltet werden.", "AI-analyse kan worden ontgrendeld met het Expert-abonnement."],
  "Lancez une lecture IA du contexte de marché actuellement affiché.": ["Run an AI analysis of the market context currently displayed.", "Starten Sie eine KI-Analyse des aktuell angezeigten Marktkontexts.", "Start een AI-analyse van de momenteel getoonde marktcontext."],
  "Voir l’analyse détaillée": ["View detailed analysis", "Detaillierte Analyse anzeigen", "Bekijk de gedetailleerde analyse"],
  "Votre quota mensuel d’analyses IA est atteint. Consultez votre abonnement.": ["Your monthly AI analysis quota has been reached. Check your subscription.", "Ihr monatliches Kontingent für KI-Analysen ist aufgebraucht. Prüfen Sie Ihr Abonnement.", "Uw maandelijkse quotum voor AI-analyses is bereikt. Bekijk uw abonnement."],
  "Le contexte récent de cet actif est intégré.": ["Recent context for this asset is included.", "Der aktuelle Kontext dieses Vermögenswerts wird berücksichtigt.", "Recente context voor dit activum is opgenomen."],
  "Aucun contexte macro récent connecté : aucun biais ajouté.": ["No recent macro context connected: no bias added.", "Kein aktueller Makrokontext verbunden: kein zusätzlicher Einfluss.", "Geen recente macrocontext verbonden: geen invloed toegevoegd."],
  "L’analyse IA n’est pas encore activée sur ce site. Les indicateurs techniques restent disponibles.": ["AI analysis is not yet enabled on this site. Technical indicators remain available.", "Die KI-Analyse ist auf dieser Website noch nicht aktiviert. Technische Indikatoren bleiben verfügbar.", "AI-analyse is nog niet ingeschakeld op deze site. Technische indicatoren blijven beschikbaar."],
  "La connexion au service IA doit être rétablie par l’administrateur.": ["The administrator needs to restore the AI service connection.", "Der Administrator muss die Verbindung zum KI-Dienst wiederherstellen.", "De beheerder moet de verbinding met de AI-dienst herstellen."],
  "Connectez-vous à votre compte pour utiliser l’analyse IA.": ["Sign in to your account to use AI analysis.", "Melden Sie sich an, um die KI-Analyse zu nutzen.", "Meld u aan om AI-analyse te gebruiken."],
  "L’analyse IA est incluse dans la formule Expert. Consultez votre compte.": ["AI analysis is included in Expert. Check your account.", "Die KI-Analyse ist in Expert enthalten. Öffnen Sie Ihr Konto.", "AI-analyse is inbegrepen bij Expert. Bekijk uw account."],
  "Votre compte est suspendu. Contactez l’administrateur.": ["Your account is suspended. Contact the administrator.", "Ihr Konto ist gesperrt. Kontaktieren Sie den Administrator.", "Uw account is geschorst. Neem contact op met de beheerder."],
  "L’analyse a pris trop de temps. Vous pouvez réessayer.": ["The analysis took too long. You can try again.", "Die Analyse hat zu lange gedauert. Sie können es erneut versuchen.", "De analyse duurde te lang. U kunt het opnieuw proberen."],
  "Chargement des données…": ["Loading data…", "Daten werden geladen…", "Gegevens laden…"],
  "Vérifier l’activation": ["Check activation", "Aktivierung prüfen", "Activering controleren"],
  "Activation en attente": ["Activation pending", "Aktivierung ausstehend", "Activering in afwachting"],
  ...
  Valeur: ["Value", "Wert", "Waarde"],
  "Lecture actuelle": ["Current reading", "Aktuelle Analyse", "Huidige lezing"],
  Pourquoi: ["Why", "Warum", "Waarom"],
  "PREUVE PRINCIPALE": ["PRIMARY EVIDENCE", "HAUPTBELEG", "HOOFDBEWIJS"],
  "ICHIMOKU MIS EN ÉVIDENCE": ["ICHIMOKU HIGHLIGHT", "ICHIMOKU IM FOKUS", "ICHIMOKU UITGELICHT"],
  "La preuve visuelle du marché actuel": ["Visual evidence of the current market", "Visueller Beleg des aktuellen Marktes", "Visueel bewijs van de huidige markt"],
  "Pourquoi ce verdict ?": ["Why this verdict?", "Warum dieses Urteil?", "Waarom dit oordeel?"],
  "Condition de validation :": ["Validation condition:", "Bestätigungsbedingung:", "Bevestigingsvoorwaarde:"],
  "Lecture éducative, non prédictive. Les gaps, horaires de marché et annonces peuvent invalider rapidement un signal.": ["Educational, non-predictive reading. Gaps, market hours and announcements can quickly invalidate a signal.", "Lehrreiche, nicht prognostische Analyse. Kurslücken, Handelszeiten und Meldungen können ein Signal schnell entkräften.", "Educatieve, niet-voorspellende lezing. Gaps, markturen en nieuws kunnen een signaal snel ongeldig maken."],
  ...
  "MARCHÉ OUVERT": ["MARKET OPEN", "MARKT GEÖFFNET", "MARKT OPEN"],
  "MARCHÉ FERMÉ": ["MARKET CLOSED", "MARKT GESCHLOSSEN", "MARKT GESLOTEN"],
  "heure locale": ["local time", "Ortszeit", "lokale tijd"],
  "INDICATEURS TECHNIQUES": ["TECHNICAL INDICATORS", "TECHNISCHE INDIKATOREN", "TECHNISCHE INDICATOREN"],
  "Lecture instantanée sur": ["Instant reading on", "Sofortanalyse auf", "Directe analyse op"],
  "Les calculs utilisent exactement l’historique de la période active et se recalculent lors de chaque changement.": ["Calculations use the exact history of the active timeframe and update with every change.", "Die Berechnungen verwenden exakt die Historie des aktiven Zeitraums und werden bei jeder Änderung aktualisiert.", "De berekeningen gebruiken exact de historie van de actieve periode en worden bij elke wijziging bijgewerkt."],
  "Tendance haussière": ["Bullish trend", "Aufwärtstrend", "Stijgende trend"],
  "Tendance baissière": ["Bearish trend", "Abwärtstrend", "Dalende trend"],
  "Direction moyenne du prix": ["Average price direction", "Durchschnittliche Preisrichtung", "Gemiddelde prijsrichting"],
  "Zone de surachat": ["Overbought zone", "Überkaufte Zone", "Overbought-zone"],
  "Zone de survente": ["Oversold zone", "Überverkaufte Zone", "Oversold-zone"],
  "Zone équilibrée": ["Balanced zone", "Ausgeglichene Zone", "Evenwichtige zone"],
  "Momentum moyen positif": ["Positive average momentum", "Positives durchschnittliches Momentum", "Positief gemiddeld momentum"],
  "Momentum moyen négatif": ["Negative average momentum", "Negatives durchschnittliches Momentum", "Negatief gemiddeld momentum"],
  "Bandes de Bollinger": ["Bollinger Bands", "Bollinger-Bänder", "Bollinger Bands"],
  "Zone statistique autour de la moyenne 20": ["Statistical range around the 20-period average", "Statistischer Bereich um den 20-Perioden-Mittelwert", "Statistische zone rond het 20-periodegemiddelde"],
  "Amplitude moyenne, pas une direction": ["Average range, not a direction", "Durchschnittliche Spanne, keine Richtung", "Gemiddelde bandbreedte, geen richting"],
  "INDICATEUR MIS EN ÉVIDENCE": ["FEATURED INDICATOR", "HERVORGEHOBENER INDIKATOR", "UITGELICHTE INDICATOR"],
  "Ce que montre la forme actuelle": ["What the current shape shows", "Was die aktuelle Form zeigt", "Wat de huidige vorm toont"],
  "le nuage": ["the cloud", "der Wolke", "de cloud"],
  "nuage comprimé": ["compressed cloud", "komprimierte Wolke", "samengedrukte cloud"],
  "nuage épais": ["thick cloud", "dicke Wolke", "dikke cloud"],
  "nuage équilibré": ["balanced cloud", "ausgeglichene Wolke", "evenwichtige cloud"],
  "Équilibre rapide sur 9 périodes": ["Fast equilibrium over 9 periods", "Schnelles Gleichgewicht über 9 Perioden", "Snel evenwicht over 9 periodes"],
  "Équilibre de fond sur 26 périodes": ["Core equilibrium over 26 periods", "Grundgleichgewicht über 26 Perioden", "Basisevenwicht over 26 periodes"],
  "Limites du nuage projeté": ["Projected cloud boundaries", "Grenzen der projizierten Wolke", "Grenzen van de geprojecteerde cloud"],
  "Chikou théorique": ["Theoretical Chikou", "Theoretischer Chikou", "Theoretische Chikou"],
  "Prix comparé à 26 périodes en arrière": ["Price compared with 26 periods ago", "Preis im Vergleich zu vor 26 Perioden", "Prijs vergeleken met 26 periodes geleden"],
  "Lecture instantanée": ["Instant reading", "Sofortanalyse", "Directe analyse"],
  "Au moins 52 observations valides sont nécessaires pour calculer Ichimoku sans inventer de valeurs.": ["At least 52 valid observations are required to calculate Ichimoku without fabricating values.", "Mindestens 52 gültige Beobachtungen sind nötig, um Ichimoku ohne erfundene Werte zu berechnen.", "Minstens 52 geldige waarnemingen zijn nodig om Ichimoku zonder verzonnen waarden te berekenen."],
  "Chargement de l’historique technique…": ["Loading technical history…", "Technische Historie wird geladen…", "Technische historie laden…"],
  "Les données techniques ne sont momentanément pas disponibles.": ["Technical data is temporarily unavailable.", "Technische Daten sind vorübergehend nicht verfügbar.", "Technische gegevens zijn tijdelijk niet beschikbaar."],
  "Réessayer le chargement": ["Retry loading", "Erneut laden", "Opnieuw laden"],
  "GRAPHIQUE MIXTE": ["MIXED CHART", "KOMBINIERTER CHART", "GEMENGDE GRAFIEK"],
  "Éléments visibles du graphique": ["Visible chart elements", "Sichtbare Chart-Elemente", "Zichtbare grafiekelementen"],
  Nuage: ["Cloud", "Wolke", "Cloud"],
  Lignes: ["Lines", "Linien", "Lijnen"],
  Signaux: ["Signals", "Signale", "Signalen"],
  "prix réel": ["real price", "realer Kurs", "reële prijs"],
  "Historique trop court pour Ichimoku": ["History too short for Ichimoku", "Historie für Ichimoku zu kurz", "Historie te kort voor Ichimoku"],
  "Au moins 52 observations valides sont nécessaires. Choisissez une période compatible pour afficher le graphique sans inventer de valeurs.": ["At least 52 valid observations are required. Choose a compatible timeframe to display the chart without fabricating values.", "Mindestens 52 gültige Beobachtungen sind erforderlich. Wählen Sie einen kompatiblen Zeitraum, um das Diagramm ohne erfundene Werte anzuzeigen.", "Minstens 52 geldige waarnemingen zijn vereist. Kies een compatibele periode om de grafiek zonder verzonnen waarden weer te geven."],
  "Ichimoku utilise les plus hauts et plus bas disponibles. Les horaires de marché, les gaps et les annonces peuvent modifier rapidement sa lecture ; ce signal reste éducatif et non prédictif.": ["Ichimoku uses the available highs and lows. Market hours, gaps and announcements can quickly change its reading; this signal remains educational and non-predictive.", "Ichimoku nutzt die verfügbaren Hochs und Tiefs. Handelszeiten, Gaps und Meldungen können die Analyse schnell verändern; das Signal bleibt lehrreich und nicht prognostisch.", "Ichimoku gebruikt de beschikbare hoogste en laagste koersen. Markturen, gaps en nieuws kunnen de analyse snel wijzigen; dit signaal blijft educatief en niet voorspellend."],
};
