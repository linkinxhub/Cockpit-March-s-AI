...
test('sync manifest publishes contract version and endpoints',()=>{assert.match(manifest,/schemaVersion:'1\.4\.0'/);for(const endpoint of ['/api/me','/api/scanner','/api/history','/api/indicators','/api/ichimoku-history','/api/market-status','/api/news','/api/news-alerts'])assert.match(manifest,new RegExp(endpoint.replaceAll('/','\\/')));});
